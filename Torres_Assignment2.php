...
<div class="w3-main" style="margin-left:250px">
  ...
  <div class="w3-row w3-padding-64">
    <div class="w3-twothird w3-container">
      ...
      <p>This is a contact page where you can get in touch with the training staff who run the fitness page. Here, you can ask questions related to fitness and health and expect an intelligent response from a team member in a timely manner. User feedback and suggestions for improvement are also welcome. This is our prefered means of communication, but here are other ways to get in contact with our team. Thank you for your interaction, and we look forward to receiving your questions and comments! </p> 
    </div>
    <!--
  ...
  <div class="w3-center w3-padding-32">
    <div class="w3-bar">
      ...
      <a class="w3-button w3-hover-black" href="Torres_Assignment3.php">»</a>
    </div>
  </div>
