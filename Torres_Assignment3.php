...
<div class="w3-main" style="margin-left:250px">
  ...
  <div class="w3-row">
    <div class="w3-twothird w3-container">
      <h1 class="w3-text-teal">Register With Us!</h1>
      <p><form action="form3Data.php" method="post">
          <fieldset>
  ...
  <div class="w3-center w3-padding-32">
    <div class="w3-bar">
      ...
      <a class="w3-button w3-hover-black" href="Torres_Assignment4.php">»</a>
    </div>
  </div>
