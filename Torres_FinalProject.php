...
<div class="w3-main" style="margin-left:250px">
  ...
  <div class="w3-container w3-center">
    <h1 class="w3-text-teal">Final Project</h1>
     <img src="ME.JPG" alt="image of myself" width="250" height="350" style="display: block; margin: 0 auto;">
  </div>
  </div>
  <div class="w3-row w3-padding-64">
    <div class="w3-container w3-center">
      <h1 class="w3-text-teal">About the author </h1>
      <p style="max-width: 800px; margin: 0 auto; text-align: center;">This page is a resource I wish I had when I started my fitness journey. I created it because of my true passion for helping others achieve their goals. This fitness-focused platform is designed to educate and guide individuals toward improving their physical health. It emphasizes the importance of physical fitness and its numerous benefits, such as better cardiovascular health, increased muscular strength, and improved mental well-being, including reduced stress and anxiety. Most importantly, this platform aims to be a valuable resource offering personalized support to help individuals reach their fitness goals safely and effectively. </p>
    </div>
    <!--
...
<!--
  ...
  <div class="w3-center w3-padding-32">
    <div class="w3-bar">
      ...
      <a class="w3-button w3-hover-black" href="Privacy_Policy.php">»</a>
    </div>
  </div>
